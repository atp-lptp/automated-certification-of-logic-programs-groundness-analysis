...
function print_results_header {
  print_utf8 '%s'$'\t''%s'$'\t' 'lib' '#'
  print_utf8 '%s'$'\t''%s'$'\t''%s'$'\t''%s'$'\t''%s'$'\t' 'E-1s' 'E (ms)' 'V-1s' 'V (ms)' 'EV-1s'
  print_utf8 '%s'$'\t''%s'$'\t''%s'$'\t''%s'$'\t''%s'$'\t' 'E-10s' 'E (ms)' 'V-10s' 'V (ms)' 'EV-10s'
  print_utf8 '%s'$'\t''%s'$'\t''%s'$'\t''%s'$'\t''%s'$'\t' 'E-60s' 'E (ms)' 'V-60s' 'V (ms)' 'EV-60s'
  _newline
}
...
\begin{table}
    \centering
    \begin{tabular}{|l|l|l|c|c|c|c|c|l|c|c|c|c|c|l|c|c|c|c|c|} \hline
    \textit{lib}&{\#}&E-1s& E (ms) & V-1s & V (ms) & EV-1s&  E-10s& E (ms) & V-10s & V (ms)  EV-10s & E-60s & E (ms) & V-60s & V (ms) EV-60s\\ \hline
LaTeX
    )"
    _newline
}
