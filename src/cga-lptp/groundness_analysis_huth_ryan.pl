...
%    ;   true ),
    ...
    ->  (   once((
                ...
                -> (
                    ...
                    (
                        law_of_excluded_middle(VarsNoQM, [], LawOfExcludeMiddleClauses),
                        append(
                            [
                                LawOfExcludeMiddleClauses,
                                []
                            ], Gamma),
                            proof(Gamma, Conc, DerivationCases)
                    )
                ...
                ; (
                    ...
                    log__info(proving_induction_step, Gamma),
