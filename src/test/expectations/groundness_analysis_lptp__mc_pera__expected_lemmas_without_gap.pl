   ...
   [step([],[],
    ...
    step([x3,x4,x5,x6,x7],
     [gr(?x7) & gr(?x6) \/ ~ gr(?x7) & ~ gr(?x6),
      ...
      succeeds p(?x6,?x7)],
     [succeeds eq(?x3,?x4) => gr(?x4) & gr(?x3) \/ ~ gr(?x4) & ~ gr(?x3) by
       lemma(eq21),
      succeeds rev(?x4,[?x5|?x6]) => gr([?x5|?x6]) & gr(?x4) \/
       ~ gr([?x5|?x6]) & ~ gr(?x4) by lemma(rev21),
      cases(gr(?x3),
       cases(gr(?x4),
        cases(gr(?x5),
         cases(gr(?x6),
          cases(gr(?x7),
           [gr(?x7) & gr(?x6),
            ...
            gr(?x4) & gr(?x3),
            gr(?x4) & gr(?x3) \/ ~ gr(?x4) & ~ gr(?x3),
            assume((gr(?x7) & gr(?x6) \/ ~ gr(?x7) & ~ gr(?x6)) &
             ((gr(?x4) & gr(?x3) \/ ~ gr(?x4) & ~ gr(?x3)) &
              (gr([?x5|?x6]) & gr(?x4) \/ ~ gr([?x5|?x6]) & ~ gr(?x4))),[],
             gr(?x4) & gr(?x3) \/ ~ gr(?x4) & ~ gr(?x3))],
           ~ gr(?x7),
           [contra(gr(?x7) & gr(?x6),[gr(?x7),~ gr(?x7),ff]),
            ...
            contra(~ gr(?x7) & ~ gr(?x6),[]),
            ~ (~ gr(?x7) & ~ gr(?x6)),
            contra(gr(?x7) & gr(?x6) \/ ~ gr(?x7) & ~ gr(?x6),
             cases(
              [case(~ gr(?x7) & ~ gr(?x6),
                [~ gr(?x7) & ~ gr(?x6),
                 ~ (~ gr(?x7) & ~ gr(?x6)),
          ...
          cases(gr(?x7),
           [contra(gr(?x5) & gr(?x6),[]),
            ...
            contra(~ gr([?x5|?x6]) & ~ gr(?x4),[]),
            ~ (~ gr([?x5|?x6]) & ~ gr(?x4)),
            contra(gr([?x5|?x6]) & gr(?x4) \/ ~ gr([?x5|?x6]) & ~ gr(?x4),
             cases(
              [case(~ gr([?x5|?x6]) & ~ gr(?x4),
                [~ gr([?x5|?x6]) & ~ gr(?x4),
                 ~ (~ gr([?x5|?x6]) & ~ gr(?x4)),
         ...
         cases(gr(?x6),
          cases(gr(?x7),
           [contra(gr(?x5) & gr(?x6),[gr(?x5),~ gr(?x5),ff]),
            ~ (gr(?x5) & gr(?x6)),
            gr([?x5|?x6]) => gr(?x5) & gr(?x6),
            assume(~ (gr(?x5) & gr(?x6)),
             contra(gr([?x5|?x6]),
        ...
        cases(gr(?x5),
         cases(gr(?x6),
          ...
          ~ gr(?x6),
          cases(gr(?x7),
           [contra(gr(?x4) & gr(?x3),[gr(?x4),~ gr(?x4),ff]),
            ~ (gr(?x4) & gr(?x3)),
            contra(~ gr(?x3),[]),
            ~ ~ gr(?x3),
            contra(~ gr(?x4) & ~ gr(?x3),[]),
